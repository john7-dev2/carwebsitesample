    ...
    <div className="relative">
      ...
      <section className="relative h-[90vh] flex items-center text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-20 text-center">
          <div className="inline-block mb-4 px-4 py-2 bg-brand-burgundy/20 backdrop-blur-sm border border-brand-burgundy/30 rounded-full">
            <span className="text-brand-burgundy-light font-semibold text-sm tracking-wider uppercase">Quality, Efficiency, Reliability and Satisfaction</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="bg-gradient-to-r from-brand-burgundy to-brand-burgundy-dark hover:from-brand-burgundy-dark hover:to-brand-black text-white px-10 py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-brand-burgundy/50 transform hover:-translate-y-0.5"
            >
              View Inspection Packages
            </button>
            <button
              onClick={() => onNavigate('contact')}
              className="bg-white/10 backdrop-blur-md border-2 border-white/30 text-white hover:bg-white hover:text-gray-900 px-10 py-4 rounded-xl font-semibold transition-all duration-300 shadow-lg hover:shadow-white/50 transform hover:-translate-y-0.5"
            >
              Book Inspection
            </button>
          </div>
      ...
      <section className="py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-brand-burgundy font-semibold text-sm tracking-wider uppercase mb-3 block">What We Offer</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Inspection Packages</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Four different packages to choose from according to your needs</p>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div className="text-3xl font-bold text-brand-burgundy mb-3">{service.price}</div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-brand-burgundy font-semibold text-sm tracking-wider uppercase mb-3 block">Advanced Tools</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Professional Equipment</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">State-of-the-art diagnostic tools for comprehensive vehicle inspection</p>
          </div>
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-gradient-to-br from-gray-50 to-white p-6 rounded-xl border border-gray-200 hover:border-brand-burgundy/30 hover:shadow-lg transition-all duration-300">
                <div className="w-12 h-12 bg-brand-burgundy/10 rounded-lg flex items-center justify-center mb-3">
                  <equipment.Icon className="text-brand-burgundy" size={24} strokeWidth={2} />
                </div>
                <h3 className="font-bold text-gray-900 mb-2">{equipment.name}</h3>
      ...
      <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-brand-burgundy font-semibold text-sm tracking-wider uppercase mb-3 block">How It Works</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Inspection Process</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">Simple, transparent, and professional</p>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            {[
              {
              ...
              <div key={index} className="relative">
                <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  <div className="w-16 h-16 bg-gradient-to-br from-brand-burgundy to-brand-burgundy-dark rounded-xl flex items-center justify-center mb-4">
                    <process.Icon className="text-white" size={32} strokeWidth={2} />
                  </div>
                  <div className="text-brand-burgundy font-bold text-sm mb-2">STEP {process.step}</div>
                  <h3 className="text-2xl font-bold mb-3 text-gray-900">{process.title}</h3>
                  <p className="text-gray-600 leading-relaxed">{process.description}</p>
                </div>
                {index < 3 && (
                  <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2 text-brand-burgundy text-2xl">
                    →
                  </div>
                )}
              </div>
      ...
      <section className="py-24 bg-gradient-to-br from-brand-burgundy to-brand-burgundy-dark text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="text-brand-burgundy-light font-semibold text-sm tracking-wider uppercase mb-3 block">Why Revelro</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Choose Us</h2>
            <p className="text-gray-200 text-lg max-w-2xl mx-auto">Protecting your investment with expertise and transparency</p>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-12 md:p-16 text-center text-white shadow-2xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Inspect Your Next Car?</h2>
